...
from fastchat.prompts import SYSTEM_MESSAGE
...
class Conversation:
    ...
    def overwrite_last_message(self, role: str, new_message: str):
        """
        Overwrite last message written by the user.
        """
        for i in range(1,len(self.messages)+1):
            mex = self.messages[-i]
            mex_role, message = mex
