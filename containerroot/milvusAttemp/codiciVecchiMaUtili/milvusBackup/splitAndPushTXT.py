...
# doc = Document(page_content=txtContent)
...
# for i in range(0, len(finChunks)):
#     print(finChunks[i])
#     print("\n")
...
# # # Get the IP address of the Milvus container
# # client = docker.from_env()
# # container = client.containers.get("milvus-standalone")
...
#             "ID_chunk" : j,
#             "embedding" : docs_embeddings["dense"][j] #generateRandomEmbedding(1024)#
#         }]
...
# # # entities = chunk_collection.get_entities(result_ids)
